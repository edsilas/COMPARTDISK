...
$TagFixa  = if ($env:COMPARTDISK_TAG)   { $env:COMPARTDISK_TAG }   else { 'v1.4.1' }
# Hash do pacote COMPARTDISK-1.4.1.zip anexado a tag acima. Fixa-lo aqui e mais forte
...
#
# ESTADO DE TRANSICAO: vazio ate a release v1.4.1 ser publicada e o SHA-256 do
# pacote ser conferido. Enquanto isso a integridade e validada pelo hash das notas
# da release; nao havendo hash publicado, Test-Integridade declara a limitacao em
# vez de aceitar o pacote em silencio. Manter aqui o hash da 1.4.0 faria a
# validacao recusar o pacote correto.
