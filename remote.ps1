...
$TagFixa  = if ($env:COMPARTDISK_TAG)   { $env:COMPARTDISK_TAG }   else { 'v1.4.8' }
...
$HashFixo = if ($env:COMPARTDISK_HASH)  { $env:COMPARTDISK_HASH }  else { 'ba52aa2c2198bebd7181a94cdd5a5e379d10d843ea98ccced82dc593232ca5ce' }
