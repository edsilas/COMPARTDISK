...
$TagFixa  = if ($env:COMPARTDISK_TAG)   { $env:COMPARTDISK_TAG }   else { 'v1.4.4' }
# Hash do pacote COMPARTDISK-1.4.4.zip anexado a tag acima. Fixa-lo aqui e mais forte
...
#
# ESTADO DE TRANSICAO: vazio ate a release v1.4.4 ser publicada e o pacote conferido.
...
# silencio. Manter aqui o hash da 1.4.3 faria a validacao recusar o pacote correto.
